...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("../../../../Application/shaders/5.1.transform.vs", "../../../../Application/shaders/5.1.transform.fs");
    ...
    unsigned char *data = stbi_load("../../../../Application/resources/container.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("../../../../Application/resources/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
